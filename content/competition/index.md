...
| ✅ Confirmation of participation | 8 June 2026 | **Sent!** |
...
The oral quiz is evaluated by a panel of leading neuroscientists from Belgian research institutions and science enthusiasts.

<div class="judges-grid">

<div class="judge-card">
    <img src="/images/judges/Rosa-Rademakers.jpg" alt="Rosa Rademakers">
    <h4>Rosa Rademakers</h4>
    <p>Full Research Professor. Leads the Rademakers Lab at VIB-UAntwerp, discovering and characterizing genes involved in neurological disorders, with a major focus on frontotemporal lobar degeneration (FTLD).</p>
    <a href="https://rademakerslab.sites.vib.be/en/news#/" target="_blank" width=100px rel="noopener noreferrer">Learn more →</a>
</div>

<div class="judge-card">
    <img src="/images/judges/robrechtraedt.jpg" alt="Robrecht Raedt">
    <h4>Robrecht Raedt</h4>
    <p>Associate Research Professor. President of BSN. Researches new therapies for brain cancer (glioblastoma) and glioma-associated epilepsy, focusing on repurposed drug combinations and neuroprotection against radiotherapy side effects.
 </p>
    <a href="https://site.com" target="_blank" rel="noopener noreferrer">Learn more →</a>
</div>

<div class="judge-card">
    <img src="/images/judges/larabardi.webp" alt="Lara Bardi">
    <h4>Lara Bardi</h4>
    <p>Assistant Professor at UGent. Board member of BSN. Her research lab is interested in understanding how environmental cues and/or the presence of others influence our mental processes in both social and non-social contexts.</p>
    <a href="https://bardilab.com/" target="_blank" rel="noopener noreferrer">Learn more →</a>
</div>

<div class="judge-card">
    <img src="/images/judges/bart-van-peer.jpg" alt="Bart Van Peer">
    <h4>Bart Van Peer</h4>
    <p>Nerdland podcaster. TV producer (Brain Man, De Ideale Wereld, …) and physicist.</p>
    <a href="https://podcast.nerdland.be/cast/" target="_blank" rel="noopener noreferrer">Learn more →</a>
</div>

<div class="judge-card">
    <img src="/images/judges/nathakerkhofs.png" alt="Natha Kerkhofs">
    <h4>Natha Kerkhofs</h4>
    <p>Nerdland podcaster. Works for an IT company and occasionally gets lost in the world of dinosaurs and quantum mechanics.</p>
    <a href="https://podcast.nerdland.be/cast/" target="_blank" rel="noopener noreferrer">Learn more →</a>
</div>

<div class="judge-card">
    <img src="/images/judges/peterberx.png" alt="Peter Berx">
    <h4>Peter Berx</h4>
    <p>Nerdland podcaster. Entomologist, author, lives in a world ruled by insects.</p>
    <a href="https://podcast.nerdland.be/cast/" target="_blank" rel="noopener noreferrer">Learn more →</a>
</div>
